  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 lg:px-8 pt-4 sm:pt-5">
      <motion.nav
        ...
        className="bg-white/[0.02] backdrop-blur-2xl border border-white/[0.06] rounded-2xl px-5 py-2.5 shadow-2xl shadow-black/20 max-w-2xl mx-auto"
      >
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-text-muted font-body text-[9px] uppercase tracking-[0.2em]">
                Photos
              </span>
            </div>
          </Link>
