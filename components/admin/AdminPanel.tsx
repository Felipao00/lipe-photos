...
export function AdminPanel({
  ...
  return (
    <>
      {/* Botão flutuante - Maior e no canto direito (melhor no mobile) */}
      <motion.button
        whileTap={{ scale: 0.9 }}
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 sm:p-6 border-b border-white/[0.06] flex-shrink-0">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div>
                    <h2 className="text-text-primary font-display text-lg sm:text-xl leading-none">
                      Lipe Photos
                    </h2>
                ...
                <div className="flex items-center gap-1 sm:gap-2">
                  {isAuthenticated && (
                    <button
                      ...
                      className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1.5 rounded-xl text-text-muted hover:text-text-primary hover:bg-white/[0.04] transition-colors text-[10px] sm:text-xs"
                    >
              ...
              {!isAuthenticated ? (
                <div className="p-6 sm:p-12 flex flex-col items-center justify-center flex-1">
                  ...
                  <h3 className="text-xl sm:text-2xl font-display text-text-primary mb-2">
                    Área Restrita
                  </h3>
                  <p className="text-text-secondary text-xs sm:text-sm mb-6 sm:mb-8 text-center max-w-sm px-4">
                ...
                <>
                  ...
                  <AnimatePresence>
                    {message && (
                      <motion.div
                        ...
                        exit={{ opacity: 0, y: -10 }}
                        className="mx-3 sm:mx-6 mt-3 px-3 sm:px-4 py-2.5 sm:py-3 rounded-2xl bg-green-500/10 border border-green-500/20 text-green-400 text-xs sm:text-sm flex items-center gap-2 flex-shrink-0"
                      >
                  ...
                  {/* Conteúdo das tabs - Scroll vertical */}
                      ...
                      <div className="space-y-4 sm:space-y-6">
                        <div className="p-4 sm:p-5 rounded-2xl bg-white/[0.02] border border-white/[0.04] space-y-3 sm:space-y-4">
                          ...
                          <input
                            ...
                            className="w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl bg-white/[0.03] border border-white/[0.06] text-text-primary placeholder:text-text-muted text-xs sm:text-sm focus:outline-none focus:border-white/20 transition-all"
                          />
                          ...
                          <label className="block w-full px-3 sm:px-4 py-4 sm:py-5 rounded-xl bg-white/[0.02] border border-white/[0.06] border-dashed text-text-muted text-xs sm:text-sm text-center cursor-pointer hover:border-white/20 hover:bg-white/[0.04] transition-all">
                            {uploading ? (
                              <span className="flex items-center justify-center gap-2">
                                <span className="w-3.5 h-3.5 sm:w-4 sm:h-4 border-2 border-text-muted border-t-transparent rounded-full animate-spin" />
                                Enviando...
                              </span>
                            ) : (
                              <>
                                <Upload className="w-5 h-5 sm:w-6 sm:h-6 mx-auto mb-1.5 sm:mb-2" />
                                Clique para escolher uma foto
                                <br />
                                <span className="text-[10px] sm:text-xs text-text-muted mt-1">JPG, PNG ou WebP</span>
                              </>
                            )}
                            <input
                              type="file"
                        ...
                        <div>
                          <h3 className="text-text-primary font-medium text-xs sm:text-sm mb-3 sm:mb-4">
                          ...
                          {photos.length === 0 ? (
                            <div className="text-center py-10 sm:py-12 text-text-muted">
                              ...
                              <p className="text-[10px] sm:text-xs mt-1">Use o campo acima para começar.</p>
                            </div>
                          ) : (
                            <div className="grid grid-cols-3 sm:grid-cols-4 gap-2 sm:gap-3">
                              {photos.map((photo) => (
                                <div
                                  key={photo.id}
                                  className="relative group rounded-lg sm:rounded-xl overflow-hidden bg-white/[0.02] border border-white/[0.04]"
                                >
                                  <img
                                    src={photo.image}
                                    alt={photo.title}
                                  ...
                                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button
                                      ...
                                      className="absolute top-1.5 right-1.5 sm:top-2 sm:right-2 p-1.5 sm:p-2 rounded-lg bg-red-500/90 text-white hover:bg-red-500 transition-colors"
                                    >
                                      <Trash2 className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                                    </button>
                                    <p className="absolute bottom-1.5 left-1.5 right-1.5 sm:bottom-2 sm:left-2 sm:right-2 text-white text-[10px] sm:text-xs font-medium truncate">
                                      {photo.title}
                                    </p>
                                  </div>
                                </div>
                          ...
                          <div className="flex justify-center">
                            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden bg-white/[0.03] border-2 border-white/[0.08]">
                              {logoUrl ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center text-text-muted text-[10px] sm:text-xs">
                                  Sem logo
                                </div>
                              )}
                            </div>
                          ...
                          <label className="block w-full px-3 sm:px-4 py-4 sm:py-5 rounded-xl bg-white/[0.02] border border-white/[0.06] border-dashed text-text-muted text-xs sm:text-sm text-center cursor-pointer hover:border-white/20 hover:bg-white/[0.04] transition-all">
                            {uploading ? (
                              ...
                              <>
                                ...
                                <br />
                                <span className="text-[10px] sm:text-xs text-text-muted mt-1">Recomendado: quadrada</span>
                              </>
                            )}
                            <input
                              type="file"
                      ...
                      <div className="space-y-4">
                        <div className="p-4 sm:p-5 rounded-2xl bg-white/[0.02] border border-white/[0.04] space-y-4">
                          ...
                          <textarea
                            ...
                            className="w-full px-3 sm:px-4 py-3 sm:py-4 rounded-xl bg-white/[0.03] border border-white/[0.06] text-text-primary placeholder:text-text-muted text-xs sm:text-sm focus:outline-none focus:border-white/20 transition-all resize-none leading-relaxed"
                          />
                          
                          <button
                            onClick={handleSaveAbout}
                            className="flex items-center gap-2 px-4 sm:px-5 py-2.5 sm:py-3 bg-white text-black rounded-xl font-medium text-xs sm:text-sm hover:bg-white/90 transition-all active:scale-[0.98]"
                          >
                      ...
                      <div className="space-y-4">
                        <div className="p-4 sm:p-5 rounded-2xl bg-white/[0.02] border border-white/[0.04] space-y-4">
                          ...
                          <div className="p-3 sm:p-4 rounded-xl bg-white/[0.03] border border-white/[0.06]">
                            <p className="text-text-muted text-[10px] sm:text-xs mb-1">Arquivo atual:</p>
                          ...
                          <label className="block w-full px-3 sm:px-4 py-4 sm:py-5 rounded-xl bg-white/[0.02] border border-white/[0.06] border-dashed text-text-muted text-xs sm:text-sm text-center cursor-pointer hover:border-white/20 hover:bg-white/[0.04] transition-all">
                            {uploading ? (
                              ...
                              <>
                                <Music className="w-5 h-5 sm:w-6 sm:h-6 mx-auto mb-1.5 sm:mb-2" />
                                Trocar música
                                <br />
                                <span className="text-[10px] sm:text-xs text-text-muted mt-1">Arquivo MP3</span>
                              </>
                            )}
                            <input
                              type="file"
                  ...
                  <div className="px-3 sm:px-6 py-3 sm:py-4 border-t border-white/[0.06] flex items-center justify-between flex-shrink-0 mt-auto">
                    ...
                    <button
                      onClick={() => setIsOpen(false)}
                      className="px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl text-text-muted hover:text-text-primary hover:bg-white/[0.04] transition-colors text-[10px] sm:text-xs"
                    >
                      Fechar Painel
                    </button>
                  </div>
